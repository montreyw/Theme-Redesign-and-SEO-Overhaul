...
class anthemes_topposts extends WP_Widget {
     function anthemes_topposts() {
      $widget_ops = array('description' => 'Popular Posts - Display your Popular / Top Posts by comments.' );
        parent::__construct(false, $name = 'Custom: Popular Posts',$widget_ops);
    }
...
<?php $antop = new WP_Query(array('orderby' => 'comment_count', 'posts_per_page' => esc_attr($number) )); // number to display more / less ?>
