...
class anthemes_randreviews extends WP_Widget {
    function anthemes_randreviews() {
      $widget_ops = array('description' => 'Your site\'s Random Reviews.' );
      parent::__construct(false, $name = 'Custom: Random Reviews',$widget_ops);
    }
...
<?php $anposts = new WP_Query(array('meta_key' => 'taq_review_score', 'orderby' => 'rand', 'order' => 'DESC', 'posts_per_page' => esc_attr($number) )); // number to display more / less ?>
