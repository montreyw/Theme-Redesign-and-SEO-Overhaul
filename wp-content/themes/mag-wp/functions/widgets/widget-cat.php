...
<?php query_posts( array( 'post_type' => 'post', 'category_name' => esc_attr($artcat), 'posts_per_page' => esc_attr($number)) ); ?>
...
?>
        ...
        <p>
         ...
         <p>
          ...
          <p>
          <label for="<?php echo $this->get_field_id('artcat'); ?>">Category:</label>      
