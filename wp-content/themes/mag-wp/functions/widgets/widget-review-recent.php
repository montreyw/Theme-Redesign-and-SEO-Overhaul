...
class anthemes_recentreviews extends WP_Widget {
    function anthemes_recentreviews() {
      $widget_ops = array('description' => 'Your site\'s Recent Reviews.' );
      parent::__construct(false, $name = 'Custom: Recent Reviews',$widget_ops); 
    }
...
<?php $anposts = new WP_Query(array('meta_key' => 'taq_review_score', 'orderby' => 'date', 'order' => 'DESC', 'posts_per_page' => esc_attr($number) )); // number to display more / less ?>
