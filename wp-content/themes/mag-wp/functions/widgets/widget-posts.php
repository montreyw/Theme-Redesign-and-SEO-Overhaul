...
class anthemes_recentposts extends WP_Widget {
     function anthemes_recentposts() {
      $widget_ops = array('description' => 'Your site\'s most recent Posts.' );
        parent::__construct(false, $name = 'Custom: Recent Posts',$widget_ops); 
    }
...
<?php $anposts = new WP_Query(array('post_type' => 'post', 'posts_per_page' => esc_attr($number) )); // number to display more / less ?>
